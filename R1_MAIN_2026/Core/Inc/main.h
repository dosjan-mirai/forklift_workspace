...
#define ESP_SIGNAL_OUT1_Pin GPIO_PIN_5
#define ESP_SIGNAL_OUT1_GPIO_Port GPIOA
...
#define ESP_SIGNAL_OUT2_Pin GPIO_PIN_3
#define ESP_SIGNAL_OUT2_GPIO_Port GPIOB
